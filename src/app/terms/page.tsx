    ...
    <div className="min-h-screen pt-32 pb-20 bg-[#F8F9FB]">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm text-[#6B7280] space-y-6 leading-relaxed">
          <p>Welcome to 7H . By accessing and using this website, you accept and agree to be bound by the terms and provision of this agreement.</p>
          ...
          <p>All content included on this site, such as text, graphics, logos, images, and software, is the property of 7H  and protected by international copyright laws.</p>
        </div>
      </div>
    </div>
  );
