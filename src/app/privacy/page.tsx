    ...
    <div className="min-h-screen pt-32 pb-20 bg-[#F8F9FB]">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm text-[#6B7280] space-y-6 leading-relaxed">
          <p>At OG Old Gold, we respect your privacy and are committed to protecting your personal data. This privacy policy informs you about how we look after your personal data when you visit our website.</p>
