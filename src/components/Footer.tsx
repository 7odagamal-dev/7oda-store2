        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                className="w-9 h-9 rounded-full border border-[#E5E7EB] flex items-center justify-center text-[#6B7280] hover:text-[#8BA4B8] hover:border-[#8BA4B8] transition-all duration-300"
              >
          ...
          <div className="md:col-span-3">
            ...
            <a
              ...
              className="text-sm text-[#8BA4B8] hover:text-[#6B8BA0] transition-colors mt-2 inline-block"
            >
